...
const ChangePassword = () => {
  ...
  return (
    <div className="w-full px-5">
      <h1 className="text-[25px] text-center font-[500] text-[#000000b2] pb-2">
        Change Password
      </h1>
      <div className="w-full">
        <form
...
const Address = () => {
  ...
  return (
    <div className="w-full px-5">
      {open && (
        <div className="fixed w-full h-screen bg-[#00000050] top-0 left-0 flex items-center justify-center">
      ...
      <div className="flex w-full items-center justify-between">
        <h1 className="text-[25px] font-[500] text-[#000000b2] pb-2">
          My address
        </h1>
        <div
        ...
        user.addresses.map((item, index) => (
          ...
          >
            <div className="flex items-center">
              <h3 className="pl-5 font-[600]">{item.addressType}</h3>
            </div>
